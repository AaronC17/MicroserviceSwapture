  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'typing-speed': resolve(__dirname, 'typing-speed/index.html'),
        'file-converter': resolve(__dirname, 'file-converter/index.html'),
        'bg-remover': resolve(__dirname, 'bg-remover/index.html'),
      },
    },
  },
  server: {
